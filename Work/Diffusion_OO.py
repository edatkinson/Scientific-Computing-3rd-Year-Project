...
from sparse_dense_bvp import setup_finite_difference_matrix


class DiffusionSimulation:
    def __init__(self, a, b, D, initial_condition, boundary_conditions, N, time_span, method, dt=None):
        self.a = a
        self.b = b
        self.D = D
...
dt = 0.5*dt_max
print(f"Using dt={dt}")
simulation = DiffusionSimulation(a, b, D, initial_condition, boundary_conditions, N, (0, T), method='explicit_euler', dt=dt)
